...
echo "####################"
poetry run python3 fixtranscribeanime.py -r slimetest/sreference04.srt -o soutput04.srt slimetest/stranscription04.srt --delay 0 --no-g2pw > log.txt
...
echo "####################"
poetry run python3 fixtranscribeanime.py -r ../slimetest/sreference06.srt -o ../slimetest/soutput06.srt ../slimetest/stranscription06.srt --delay 0 --no-g2pw > /dev/null
